...
$(document).ready(function(){
    ...
    var caiID = document.getElementById('cai');
    var aaronID = document.getElementById('aaron');
    var chrisID = document.getElementById('chris');
    ...
    backgroundAaron = parseFloat(backgroundAaron.substr(0,7));

    $('#cai .score').text(backgroundCai);
    caiID.setAttribute('data-score', backgroundCai)
    ...
    // Add leader class for green background
